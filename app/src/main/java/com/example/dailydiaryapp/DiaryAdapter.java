...
public class DiaryAdapter extends RecyclerView.Adapter<DiaryAdapter.DiaryViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final DiaryAdapter.DiaryViewHolder holder, int position) {
        if(!mCursor.moveToPosition(position)){
            return;
        }
        String title = mCursor.getString(mCursor.getColumnIndex(DiaryContract.DiaryEntry.COLUMN_TITLE));
        String description = mCursor.getString(mCursor.getColumnIndex(DiaryContract.DiaryEntry.COLUMN_DESCRIPTION));
        String date = mCursor.getString(mCursor.getColumnIndex(DiaryContract.DiaryEntry.COLUMN_DATE));
